# USAGE
# python ncs_video_objectdetection.py --graph graphs/mobilenetgraph --display 1
# python ncs_video_objectdetection.py --graph graphs/mobilenetgraph --confidence 0.5 --display 1
